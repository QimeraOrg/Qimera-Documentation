...
2. **Clone the repository.**
    * From the **Current Repository** menu, choose **Add → Clone repository…**
    * Locate **Qimera** in the list and pick the branch or tag that matches the version you need:
        - **Qimera V2** — built for **Unreal Engine 4.27**
